  ...
  const caseStudies = [
    {
      ...
      process:
        "Through the 12-week journey, Sarah uncovered that her drive came from proving herself to others, not from genuine passion. We reset her nervous system, rebuilt her identity around her values, and designed a business that aligned with her authentic self.",
      results: [
    ...
    },
    {
      ...
      process:
        "Michael was trapped in a cycle of achieving and still feeling unfulfilled. We discovered his perfectionism was a defense mechanism rooted in childhood experiences. By addressing his nervous system dysregulation and rebuilding his sense of self-worth, he transformed his relationship with success.",
      results: [
    ...
    },
    {
      ...
      process:
        "Jessica had spent years becoming who she thought she should be. The disconnect between her public persona and private self was causing deep anxiety. We systematically deconstructed her false identity and rebuilt one rooted in her true values and desires.",
      results: [
      ...
      quote:
        "I didn't realize how much energy it took to be someone I wasn't. Now I show up as me, and everything feels easier.",
    },
  ];
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-light/80 leading-relaxed">
              These aren't testimonials crafted for marketing. They're the
              stories of people who did the work, changed their system, and
        ...
        <div className="container-custom">
          <div className="max-w-5xl mx-auto space-y-20">
            {caseStudies.map((study, index) => {
              ...
              return (
                <div key={index} ref={studyRef} className="fade-in">
                  <div className="grid lg:grid-cols-5 gap-12">
                    ...
                    <div className="lg:col-span-3 space-y-8">
                      <div>
                        <h4 className="text-2xl text-white mb-4 font-light">
                          The Problem
                        </h4>
                        ...
                        <ul className="space-y-4">
                          {study.results.map((result, i) => (
                            <li key={i} className="flex items-start gap-3">
                              ...
                              <span className="text-light/70 text-lg">
                                {result}
                              </span>
                            </li>
                          ))}
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-light/70 mb-12">
              These results are possible when you commit to doing the deep work.
              If you're ready to stop surviving and start thriving, let's talk.
            </p>
            <button
