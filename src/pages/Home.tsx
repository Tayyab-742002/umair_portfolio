          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  title: 'The Grind',
                  description: 'You work harder, try every productivity hack, but nothing changes. The exhaustion deepens.',
                },
                {
                  title: 'The Mask',
                  description: 'From the outside, you look successful. Inside, you feel like an imposter running on empty.',
                },
                {
                  title: 'The Loop',
                  description: 'Every attempt at change fails. Diets, routines, mindset shifts—they all fade after a few weeks.',
                },
              ].map((item, index) => (
                <div
                  key={index}
                ...
                >
                  ...
                  <h3 className="text-2xl text-white mb-4 font-light">{item.title}</h3>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center mb-20">
            ...
            <p className="text-xl text-light/70 leading-relaxed">
              The problem isn't your habits or willpower. It's the internal system running beneath them.
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                icon: Zap,
                title: 'Energy',
                description: 'Nervous system regulation and sustainable vitality',
              },
              {
                icon: Target,
                title: 'Behavior',
              ...
              >
                ...
                <p className="text-light/60 text-sm leading-relaxed">{pillar.description}</p>
              </div>
            ))}
          </div>
              ...
              <div className="border-l-2 border-blue pl-8 cursor-hover">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-light/60 text-sm">Tech Executive turned Entrepreneur</p>
                  </div>
                </div>
              </div>
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-light/70 mb-12">
              Take the 5-minute self-audit and discover where you're really operating from.
            </p>
            <button
              onClick={() => onNavigate('self-audits')}
